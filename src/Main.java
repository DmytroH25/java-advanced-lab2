...
public class Main {
  ...
  public static void main(String[] args) throws IllegalAccessException {
    ...
    System.out.println(ManualSerializer.toJson(library));
    System.out.println(ManualSerializer.toJson(member));
    System.out.println(ManualSerializer.toXml(book));
    System.out.println(ManualSerializer.toXml(library));
    System.out.println(ManualSerializer.toXml(member));
    end = System.nanoTime();
